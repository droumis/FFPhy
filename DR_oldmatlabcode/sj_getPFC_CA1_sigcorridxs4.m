...
% Similar to sj_getPFC_CA1_sigidxs
...
gatherdatafile = [savedir 'HP_ThetacovAndRipmodcorr_std3_speed4_ntet2_alldata_gather_2-12-2014'];

% Pre version4
% %Update - 04 Feb 2014
%gatherdatafile = [savedir 'HP_ThetacovAndRipmodcorr_newtimefilter_alldata_gather3_feb14'];
...
[y, m, d] = datevec(date);
savefile = [savedir 'HP_allPFCCA1sigcorridxs_',num2str(m),'-',num2str(d),'-',num2str(y)]
