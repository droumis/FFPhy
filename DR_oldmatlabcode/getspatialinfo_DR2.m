function out = getspatialinfo_DR2(index, excludetimes, linpos, spikes, includestates, minV, varargin)
...
%happens but i think it's a rounding error or something
