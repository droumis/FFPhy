...
%%DR there's a problem here...  you need to feed it 
eegz=(eeg-eegmean)./stdev;
eegzmean=quantile(eegz,0.95);
baseline=eegzmean;
% find the events
