...
% Pre version4
%gatherdatafile = [savedir 'HP_ripmod_glmfit_gather2_feb14'];
...
[y, m, d] = datevec(date);
savefile = [savedir 'HP_allPFCCA1sigidxs_',num2str(m),'-',num2str(d),'-',num2str(y)];
%savefile = [savedir 'HP_allPFCCA1sigidxs_feb14'];
