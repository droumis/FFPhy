function overlap = calcoverlap_ver0(trajdata1,trajdata2, varargin)
% Shantanu- Renamed from calcoverlap. Less control and no normalization as compared to calcoverlap from "Functions"
thresh = 0;
