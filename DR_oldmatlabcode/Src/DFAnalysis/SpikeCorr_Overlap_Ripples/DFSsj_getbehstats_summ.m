...
if figopt1 == 1
    ...
    if savefig1==1,
        figfile = [figdir,'ConExpNor_MeanSpeed'];
        print('-dpdf', figfile);
        print('-djpeg', figfile);
    ...
    %Only Con vs Exp: pgrp=0.3289, ptime=0, pint=0.3288
    % Con, Exp Nor: pgrp=0.0424, ptime=0, pint=0.0712
    ...
    if savefig1==1,
        figfile = [figdir,'ConExpNor_MeanSpeedVsDays'];
        print('-dpdf', figfile);
        print('-djpeg', figfile);
        saveas(gcf,figfile,'fig');
    end
...
if dowelltime==1
    ...
    Noravgwelltime_day(2,:)=0.5*Noravgwelltime_day(2,:);
    ...
    jit=[0,0,0,0.05]; jit3=[0,0.05,0,0];
    plot(1+jit, Exp_animavgwelltime,'ro','MarkerSize',12,'Linewidth',3);
    ...
    [p_expcon_animavgwelltime,h_expcon_animavgwelltime] = ranksum(Con_animavgwelltime,Exp_animavgwelltime); %p=0.8857
    [p_expnor_animavgwelltime,h_expnor_animavgwelltime] = ranksum(Nor_animavgwelltime,Exp_animavgwelltime); %p=0.1143
    ...
    if savefig1==1,
        figfile = [figdir,'ConExp_AvgWellTime'];
        print('-dpdf', figfile);
        print('-djpeg', figfile);
        saveas(gcf,figfile,'fig');
    end
    ...
    %Con, Exp, Nor pgrp=0.4459/0.2806, ptime=0, pint=0.4351/0.4571.
    % Only Con Exp: pgrp=0.8299, ptime=0.0061, pint=0.3094
    ...
    if savefig1==1,
        figfile = [figdir,'ConExp_AvgWellTimeVsDays'];
        print('-dpdf', figfile);
        print('-djpeg', figfile);
        saveas(gcf,figfile,'fig');
    end
    ...
    jit=[0,0,0,0.05]; jit2=[0.05,0,0,0];
    plot(0.8+jit, Exp_animavgwelltime2,'ro','MarkerSize',12,'Linewidth',3);
    plot(1.2*ones(size(Con_animavgwelltime2)), Con_animavgwelltime1,'bd','MarkerSize',12,'Linewidth',3);
    plot(2.8+jit2, Exp_animavgwelltime1,'ro','MarkerSize',12,'Linewidth',3);
    plot(3.2*ones(size(Con_animavgwelltime1)), Con_animavgwelltime2,'bd','MarkerSize',12,'Linewidth',3);
    plot(4.8+jit, Exp_animavgwelltime3,'ro','MarkerSize',12,'Linewidth',3);
