function [out] = DFA_getriptriggeredspiking(index, excludeperiods, ripples, spikes, varargin)
% Shantanu - renamed from getriptriggeredspiking
...
for i = 1:length(cells(:,1))
    ...
    c1vsc2(i,:) = xcorrstruct.c1vsc2/sqrt(xcorrstruct.nspikes1*xcorrstruct.nspikes2);
end
