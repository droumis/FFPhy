...
if figopt1 == 1
    ...
    % RCc
%     Conriprate_ep2(3,5:6) = Conriprate_ep2(3,5:6)./2; Conriprate_ep2(3,5) = Conriprate_ep2(3,5)./1.4;
%     Conriprate_ep4(3,5:6) = Conriprate_ep4(3,5:6)./2; Conriprate_ep4(3,5) = Conriprate_ep4(3,5)./1.4;
...
if figopt2 == 1
    ...
    rem=[4,6,7];
    Conripsizehist_dayanim_ep2(rem,:,:)=[]; Conripsizehist_dayanim_ep4(rem,:,:)=[];
    Expripsizehist_dayanim_ep2(rem,:,:)=[]; Expripsizehist_dayanim_ep4(rem,:,:)=[];
    % Combine across days
    %-------------------------
    % Ep2
