function resultindex = JY_evaluatefilter(cellvar, filterString)
%
% resultindex = JY_evaluatefilter(cellvar, filterString)
%
...
%               '$'.
%
% Example: index = JY_evaluatefilter(cellinfo,'(($meanrate < 10) && isequal($area,''CA3''))')
...
if ~isequal(filterString, '')
    ...
    for i = 1:length(variables)
        varfetch = JY_cellfetch(cellvar, variables{i});
    ...
    cellindex = JY_cellfetch(cellvar, '');
