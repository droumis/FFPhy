function [out] = sj_getriptimes(animaldir,animalprefix, epochs, tetlist, varargin)
% out = getriptimes(animaldir,animalprefix,epochs, tetlist, options)
%
%%% Shantanu - Modified like Kenny to avoid edge effects at end of epoch.
%%% I also have a getripples_direct to use within non-filter framewrok code
%
