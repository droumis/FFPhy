...
%VIDEO_READER Opaque wrapper class around video_reader_mex
%
%   OBJ = VIDEO_READER(MPEG_FILENAME,MPEGOFFSET_FILENAME,TIMESTAMPS_FILENAME)
%
%   where the filenames must be fully-qualified path strings.
%
%   OBJ is an object with the following methods:
%     get_picture(framenum) returns the picture as a uint8 array.
%     seek(offset, origin)
%
%   OBJ.current_index reports the current framenum.
%   OBJ.timestamps is a vector of uin32 timestamps.
%     
%
