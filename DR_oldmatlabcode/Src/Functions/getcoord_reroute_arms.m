...
plot(pos(:,2),pos(:,3));
xlim([0 320]); % defines figure dimensions for specifying the points below, make bigger than the position data to see entire arena
ylim([0 240]); % resolution * pixel dimension
[x,y] = ginput_jai(9);
