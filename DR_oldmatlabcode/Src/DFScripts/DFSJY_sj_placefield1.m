...
savedir = '/data14/jai/H2_/';
savefile = [savedir 'Placefield'];  % n is after std is changed for mapfields
...
if runscript == 1
    ...
    cellfilter = '(isequal($area, ''CA1'') && ($meanrate < 200))'
    % Time filter
    % -----------
    ...
    PSf = JY_createfilter('animal',animals,'epochs',epochfilter,'cells',cellfilter,'excludetimefilter', timefilter);
