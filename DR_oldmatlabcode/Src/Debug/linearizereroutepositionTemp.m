...
function [statematrix, segmenttable, trajwells, wellSegmentInfo, segmentInfo, ...
    trajmatrix] = linearizereroutepositionTemp(directoryname,fileprefix, index, varargin)
...
% use this information to recrease sequence of segments in each trial



%% get the foodwell enter and exit times: [starttime startwell endwell]
trajmatrix = gettraject(pos, welllocations,trajwells, lindist, wellSegmentInfo, welldist, mindiff, welldistthresh,branchpointdist,track,intersectcoord);
...
%                           
                            ...
                            for q=1:size(exitref,1);
                                exitref(q,5)=segmenttable(rowfind(exitref(q,4),segmenttable(:,1)),2);
...
function trajmatrix = gettraject(pos, welllocations,trajwells, lindist, wellSegmentInfo, welldist, mindiff, welldistthresh,branchpointdist,track,intersectcoord);
