function out = sj_plottrajdatafind4egg(animdirect,prefix,index, varargin)
% Same as sj_plottrajdatafind3
% sj_plottrajdatafind4egg('/data25/sjadhav/RippleInterruption/REf_direct/','REf',[7 4]);
