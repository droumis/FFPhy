...
void calcmeasures(double *eptr, double *startptr, double *endptr, double *dataptr, int mindur);
void Usage();
...
void calcmeasures(double *eptr, double *startptr, double *endptr, double *dataptr, int mindur)
{
    ...
    /* the maximum threshold for this event is the smaller of the two values */
