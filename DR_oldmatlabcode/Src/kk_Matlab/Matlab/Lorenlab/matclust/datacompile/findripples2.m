function ripplesnippets = findripples2(ripplestruct,minimum_duration,nstd,varargin)
...
% must remain above threshold to be counted as a ripple; this guards
...
% 0.015 s.
%
% nstd is number of standard dev that ripple must be from mean to be
% detected
% 
%
...
% precedes the ripple.  ex: pos{d}{e}.data
%
...
% into the ripplestruct.data (or the raw eeg) which correspond to the start, end, and 
