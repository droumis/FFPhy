function processdays(folderprefix, animdirect,fileprefix, days, varargin)
...
for option = 1:2:length(varargin)-1
    ...
    switch varargin{option}
        ...
        case 'thetatetrode'
            thetatetrode = varargin{option+1};
        case 'reversex'
...
for i = days
   ...
   disp(['Day ',daystring]);
   dayprocess(daydirect, animdirect,fileprefix, i, 'diodepos', diodepos, 'cmperpix', cmperpix, 'processeeg', processeeg, 'system', system, 'posfilt', posfilt, 'thetatetrode', thetatetrode, 'varprefix', varprefix, 'reversex',reversex,'reversey',reversey);
end
