...
%         cellpairfilter,'excludetime', timefilterrun_onlyrip_speed,'iterator', iterator);
    ...
    sleepcorr_all = setfilterfunction(sleepcorr_all, 'DFAsj_calcxcorrmeasures_HpPFC', {'spikes'}); % No time filter. But Corrln like ripples for 0.4 sec
    sleepcorr_rip = setfilterfunction(sleepcorr_rip, 'DFAsj_calcxcorrmeasures_HpPFC', {'spikes'}); % During ripples. Corrln for 0.4sec
    ...
    runcorr_all = setfilterfunction(runcorr_all, 'DFAsj_calcxcorrmeasures_HpPFC', {'spikes'},'forripples',0); % To get long duration cross-corrln (1 sec instead of 0.4 sec)
    runcorr_rip = setfilterfunction(runcorr_rip, 'DFAsj_calcxcorrmeasures_HpPFC', {'spikes'}); % During ripples. Corrln for 0.4sec
