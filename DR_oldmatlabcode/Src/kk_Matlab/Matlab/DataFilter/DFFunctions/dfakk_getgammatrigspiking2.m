function [out] = dfakk_getgammatrigspiking2(index, excludeperiods, lowgamma, gammal, spikes, tetinfo,varargin)
...
for i = 1:size(index,1)
    ...
    if ~isempty(spikes{index(i,1)}{index(i,2)}{index(i,3)}{index(i,4)})
        ...
        filteegtimes=geteegtimes(lowgamma{index(i,1)}{index(i,2)}{reftet});
        includedspike_indices = lookup(includedspike_times,filteegtimes);
        reftetphases = lowgamma{index(i,1)}{index(i,2)}{reftet}.data(:,2);
