...
%         keyboard
    ...
    for fnum = 1:length(flist)
        ...
        if reftognd 
        lowgammagnd{day}{epoch}{tet}.samprate = entry.samprate;
        lowgammagnd{day}{epoch}{tet}.starttime = entry.starttime;
        ...
        for i = 1:length(lo)
        	if reftognd && lo(i) > 1 && hi(i) < length(lowgammagnd{day}{epoch}{tet}.data) 
            	lowgammagnd{day}{epoch}{tet}.data(lo(i):hi(i)) = minint;
            elseif lo(i) > 1 && hi(i) < length(lowgamma{day}{epoch}{tet}.data)
