function [out] = dfakk_gethighgammatrigspiking2(index, excludeperiods, highgamma, gammah, spikes, tetinfo,varargin)
...
for i = 1:size(index,1)
        ...
        % if some other region (say CA3), identify CA1 tetrode that is most coherent to get events    
            ...
            % to the cell's tetrode
                ...
                gamma1 = highgamma{index(i,1)}{index(i,2)}{index(i,3)};
                coherences = [];
                for kk = 1:length(tetlist)
                    gamma2 = highgamma{index(i,1)}{index(i,2)}{tetlist(kk)};
    ...
    if ~isempty(spikes{index(i,1)}{index(i,2)}{index(i,3)}{index(i,4)})
        ...
        filteegtimes=geteegtimes(highgamma{index(i,1)}{index(i,2)}{reftet});
        includedspike_indices = lookup(includedspike_times,filteegtimes);
        reftetphases = highgamma{index(i,1)}{index(i,2)}{reftet}.data(:,2);
