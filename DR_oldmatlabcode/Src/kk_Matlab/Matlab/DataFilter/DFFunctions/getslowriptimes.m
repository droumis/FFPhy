function [out] = getslowriptimes(animaldir,animalprefix, epochs, tetlist, varargin)
% out = getslowriptimes(animaldir,animalprefix,epochs, tetlist, options)
%
...
% indicates the number of electrodes with a slow ripple at each time point
%
% Examples:
% getslowriptimes('/data/name/Fre', 'fre', epochs, 1)
% getslowriptimes('/data/name/Fre', 'fre', epochs, [], 'cellfilter', '(isequal($area, ''CA1''))')
...
rip = loaddatastruct(animaldir, animalprefix, 'slowripples', loaddays);
