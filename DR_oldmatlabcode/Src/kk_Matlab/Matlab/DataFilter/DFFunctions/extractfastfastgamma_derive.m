function extractfastfastgamma_derive(directoryname, fileprefix, day, tetrode, min_suprathresh_duration, nstd, varargin)
...
for t = tet
    ...
    if samethreshperday == 1
        ...
        for i = 1:length(tmpflist)
            ...
            temprenv = double(fastfastgamma{d}{e}{t}.data(:,3));
