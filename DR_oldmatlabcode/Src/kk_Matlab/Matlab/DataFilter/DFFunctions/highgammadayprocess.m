...
%
%% abandoning in favor of simply modifying slowgammadayprocess..
%% for some reason has some code differences (mainly only analyzing every other epoch)
%% 6.20.12 KK
...
if isempty(f)
    ...
    load(f)
    %eval(['load',f])        % old code.. fixed 6.20.12 KK
end
