...
% pre parameters
animal_list = {'Egypt'}
minthresh = 0;     % how big the gammal events are, in SD (usually 2)
nbins = 12;
ngammal = 0;       % usually 1, if not more
eventreg = 'CA1';
phasereg = 'CA1';
...
if ground
ca1f = setfilterfunction(ca1f, 'dfakk_getgammagndtrigspiking2', {'lowgamma','gammal','spikes','tetinfo'},'gammatetfilter',['(isequal($area, ''' phasereg ''') && ($numcells >= 2))'],'local',1,'ripple',timefilt_flag);
ca2f = setfilterfunction(ca2f, 'dfakk_getgammagndtrigspiking2', {'lowgamma','gammal','spikes','tetinfo'},'gammatetfilter',['(isequal($area, ''' phasereg ''') && ($numcells >= 2))'],'local',1,'ripple',timefilt_flag);
ca3f = setfilterfunction(ca3f, 'dfakk_getgammagndtrigspiking2', {'lowgamma','gammal','spikes','tetinfo'},'gammatetfilter',['(isequal($area, ''' phasereg ''') && ($numcells >= 2))'],'local',1,'ripple',timefilt_flag);    
else
ca1f = setfilterfunction(ca1f, 'dfakk_getgammatrigspiking2', {'lowgamma','gammal','spikes','tetinfo'},'gammatetfilter',['(isequal($area, ''' phasereg ''') && ($numcells >= 2))'],'local',1,'ripple',timefilt_flag);
ca2f = setfilterfunction(ca2f, 'dfakk_getgammatrigspiking2', {'lowgamma','gammal','spikes','tetinfo'},'gammatetfilter',['(isequal($area, ''' phasereg ''') && ($numcells >= 2))'],'local',1,'ripple',timefilt_flag);
ca3f = setfilterfunction(ca3f, 'dfakk_getgammatrigspiking2', {'lowgamma','gammal','spikes','tetinfo'},'gammatetfilter',['(isequal($area, ''' phasereg ''') && ($numcells >= 2))'],'local',1,'ripple',timefilt_flag);    
end
