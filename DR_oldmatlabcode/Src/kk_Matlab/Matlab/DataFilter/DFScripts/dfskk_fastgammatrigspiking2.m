...
ca1f = setfilterfunction(ca1f, 'dfakk_getfastgammatrigspiking2', {'fastgamma','gammaf','spikes','tetinfo'},'gammatetfilter',['(isequal($area, ''' phasereg ''') && ($numcells >= 2))'],'local',1);
ca2f = setfilterfunction(ca2f, 'dfakk_getfastgammatrigspiking2', {'fastgamma','gammaf','spikes','tetinfo'},'gammatetfilter',['(isequal($area, ''' phasereg ''') && ($numcells >= 2))'],'local',1);
ca3f = setfilterfunction(ca3f, 'dfakk_getfastgammatrigspiking2', {'fastgamma','gammaf','spikes','tetinfo'},'gammatetfilter',['(isequal($area, ''' phasereg ''') && ($numcells >= 2))'],'local',1);
...
params_string = [epoch ' epochs / ' 'timefilter: ' timefilt_flag ' / minthresh: ' num2str(minthresh) ...
                 ' / ngammaf: ' num2str(ngammaf) ' / phaseregion: ' phasereg ' / onephasetet: ' num2str(onephasetet)]
