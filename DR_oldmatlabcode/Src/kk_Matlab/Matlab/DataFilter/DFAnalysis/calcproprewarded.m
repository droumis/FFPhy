...
%
% options
%   'mindist', d  specifies the minimum departure distance from a well for a
%   trajectory to be considered valid (default 25 cm);
...
% assume W-track
correctorder = [2 1 3];
[trajbound rewarded time] = trackperformance(index, excludetimes, linpos, ...
					     correctorder, mindist);
