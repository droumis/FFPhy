function out = dfakk_thetagndphase(sind, tind, excludetimes, spikes, thetagnd, varargin)
...
t = geteegtimes(thetagnd{tind(1)}{tind(2)}{tind(3)});          % eeg clock time

tph = thetagnd{tind(1)}{tind(2)}{tind(3)}.data(:,2);           % theta phase vector
