function toppeak = sj_dayprocess(daydirect, animdirect, fileprefix, daynum, varargin)
...
%% Position is needed also for spikesonly, so do it but dont save it - Can I load instead?
