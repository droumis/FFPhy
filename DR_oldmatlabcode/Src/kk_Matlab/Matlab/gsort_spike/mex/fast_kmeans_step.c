...
/* Shantanu: need libmwblas.lib / libmwlapack.lib 
 * For dgemm_ on line 78 on linux64, using mex -l mwblas fast_kmeans.c
 * cannot find min_ on line 135 and 168, use fmin from math.h, or define your own min
 */ 
...
void fixSingletons(int mcols, int ncols, double *clustsizes, 
                   unsigned long *assigns, double *bestdists, double *distsq);
               ...
               int mcols, int ncols, int drows)
{
  ...
  dgemm_(&cht, &chn, &mcols, &ncols, &drows, &minus2,
