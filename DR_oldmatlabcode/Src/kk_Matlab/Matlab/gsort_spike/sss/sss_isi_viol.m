...
function spikes = sss_isi_viol(spikes, useassigns, show, useISI, plot_ampl)
...
for clust = 1:length(show)
    ...
    for i=1:length(viol),
        ...
        title([num2str(i) ' / ' num2str(length(viol))]);
        %Choose what to remove: red=viol=1, green=viol-1=2, none=0, both =3
