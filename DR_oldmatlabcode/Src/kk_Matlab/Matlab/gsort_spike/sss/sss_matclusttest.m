function sss_matclusttest(spikes, assignments, show, mode, nch)
...
for clu = 1:numclusts
	...
	inds{clu} = sel;
    if (strcmp(mode, 'xyz'))
        hndl = plot3(data(sel,2), data(sel,3), data(sel,4),'.','MarkerSize',2);
    else
...
ssg.xchoice = 'Signal';     ssg.xparam1 = '2';      ssg.xcontrol = [];
ssg.ychoice = 'Signal';     ssg.yparam1 = '3';      ssg.ycontrol = [];
ssg.zchoice = 'Signal';     ssg.zparam1 = '4';      ssg.zcontrol = [];
guidata(gcf, ssg);
