...
%   $Revision: 2.35.4.8 $  $Date: 2006/10/02 16:35:12 $

if nargin==0
    % No data given, so launch stepwise using sample data.
    msg = sprintf(['To use STEPWISE with your own data, type:\n\n' ...
               '        stepwise(x,y)\n\n' ...
               'Type "help stepwise" for more information\n\n\n' ...
               'Click OK to analyze some sample data (the Hald data).']);
    title = 'Starting STEPWISE';
...
if nargs<2, error('stats:stepwise:InvalidSyntax','Must supply X and Y.'); end
