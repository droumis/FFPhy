...
%   $Revision: 1.1.8.3 $  $Date: 2006/12/15 19:30:32 $
...
if nargin < 2
    ...
    oldlevels = checklabels(oldlevels,1); % warn and remove if duplicates
...
%             oldcodes(i) = 0;
    ...
    if elementsUndefined
        warning('stats:categorical:addlevels:UndefinedLevelAssigned', ...
                sprintf(['OLDLEVELS contains categorical levels that were present in A,\n' ...
                         'caused some array elements to have undefined levels.']));
    end
end
