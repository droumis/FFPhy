...
%   NDIMS(A), M will be 1.
%
%   See also CATEGORICAL/LENGTH, CATEGORICAL/NDIMS, CATEGORICAL/NUMEL.

%   Copyright 2006 The MathWorks, Inc. 
%   $Revision: 1.1.8.2 $  $Date: 2006/12/15 19:31:10 $

if nargin == 1
    varargout = cell(1,max(nargout,1));
    [varargout{:}] = size(a.codes);
else
    varargout = cell(1);
    varargout{:} = size(a.codes,dim);
end
