...
%   Setting 'DatasetOutput' to FALSE specifies that the type of the output(s)
%   from DATASETFUN is determined by 'UniformOutput'.
%
...
%   $Revision: 1.1.6.2.2.1 $  $Date: 2007/01/08 20:32:35 $
