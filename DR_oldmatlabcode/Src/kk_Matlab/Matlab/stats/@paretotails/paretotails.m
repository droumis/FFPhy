...
%
%   See also ECDF, KSDENSITY, GPFIT, PIECEWISEDISTRIBUTION/CDF, PIECEWISEDISTRIBUTION/ICDF.

%   Copyright 2006-2007 The MathWorks, Inc. 
%   $Revision: 1.1.8.2.2.1 $  $Date: 2007/01/16 03:38:11 $

    properties(GetAccess='private', SetAccess='private')
        lowerparams = [];  % parameters of lower-tail Pareto, or [] if none
        upperparams = [];  % parameters of upper-tail Pareto, or [] if none
        pLower = [];       % lower tail probablity, 0<=pLower<1
