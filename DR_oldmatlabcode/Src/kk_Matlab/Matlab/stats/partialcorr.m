...
%   $Revision: 1.1.6.1 $  $Date: 2005/05/31 16:44:48 $
...
case {'a' 'c'} % 'all' 'complete'
    ...
    % Some of the X variables might be perfectly predictable from Z, but
    % roundoff could throw that off.  If a column of residuals is effectively
    % zero relative to the original variable, then assume we've predicted
    % exactly.  This prevents computing spuriously valid correlations when
    % they really should be NaN.
