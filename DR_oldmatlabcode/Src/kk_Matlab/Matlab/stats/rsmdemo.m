...
%   $Revision: 2.27.4.5 $  $Date: 2006/10/02 16:35:06 $
...
set(fact_fig,'Backingstore','off','Resize','off',...
...
uicontrol('Style','Pushbutton','Units','pixels','Position',[5 5 100 20],...
...
uicontrol('Style','Pushbutton','Units','pixels','Position',[5 188 150 20],...
             'Callback',['rsmdemo(''doe'',' figlist],...
             'String','Do Experiment','Tag','doe_button');

uicontrol('Style','Pushbutton','Units','pixels','Position',[5 5 110 20],...
             'Callback',['rsmdemo(''fit1'',' figlist],...
             'String','Response Surface');

uicontrol('Style','Pushbutton','Units','pixels','Position',[120 5 110 20],...
...
doe_axes = axes;
set(doe_axes,'Units','pixels','Position',[1 1 300 210],'Visible','off','DrawMode','fast',...
