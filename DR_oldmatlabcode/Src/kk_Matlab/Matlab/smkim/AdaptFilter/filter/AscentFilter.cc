/* $Id: AscentFilter.cc,v 1.8 2008/09/01 18:24:22 chengs Exp $
...
void AscentFilter::runFilter()
{
    ...
    while ((numiter < niter) && !converged) {
        cerr << "iteration " << ++numiter;
...
//    MX_FieldScalarDefault(MexParam, "maxGradient", maxGradient, 50, double);
    maxGradient= 1000; //@@
