...
animalprefix = 'flo';                              % to label graphs later
eventtype = 'ripples';                              % must be the same name as the events' data structure
days = 1;                                           % days to analyze
ref_tetrode = 5;                                   % reference tetrode for events
reward_bits = 6:8;
epochs = 14;                                         % epochs to analyze
windowsize_sec=0.2;
channels=1:28;

%sitemap=[[1 3 5 0 9 11 0]' [2 4 6 8 10 12 0]' [15 17 19 21 23 0 0]' [16 0 20 22 24 26 0]'];
%sitemap=[16:31]';
sitemap=[2 4 6 8 10 12]';
    



eegstruct=loadeegstruct('/data12/kkay/Flo',animalprefix,'eeg',days,epochs,channels);
