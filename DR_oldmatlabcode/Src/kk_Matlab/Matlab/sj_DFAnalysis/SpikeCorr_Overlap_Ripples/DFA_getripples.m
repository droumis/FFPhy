function [out, ripplestdout] = DFA_getripples(index, ripples, cellinfo, varargin)
%
...
%
% Shantanu:
% Uses only 1 day and 1 epoch - weird
%
% options are
...
% cellinfo is inputed by default in this function. It is a datatype
