...
%         else pixdim=0.42;
        ...
        Epochdata=RerouteProcess_TMP_realigntimestamp(animaldir,animalnames,i,processepochs(j),configfile,pixdim,barrierport,runepoch,sleepepoch,ranges,rewardedwells);
