function jy_rippledayprocess(directoryname,fileprefix,days, varargin)
...
%
%directoryname - directory containing processed data eg 'I1_'
%                 example '/data99/user/animaldatafolder', a folder 
...
% set root
rootdir='/data14/jai/';
directoryname=strcat(rootdir,directoryname,'/');

daytetlist = [];
f = '';
defaultfilter = '/opt/hippo/filtering/ripplefilter.mat';
system = 2;
