function [Pos] = Posepochprocess_sleep(daydirect, animalname,day, epoch, varargin)
...
% 2013/03/08 - modfied from Posepochprocess by updating cmperpix and
% removing camera distortion correction.
