function jy_extractripples(directoryname, fileprefix, day, tetrode, min_suprathresh_duration, nstd, varargin)
...
eval(['load ', directoryname, '/', fileprefix, 'data', dsz, num2str(d), '.mat']); %load pos file changed 
...
for t = tet
    ...
    for i = 1:length(tmpflist)
        ...
        pos=data{1,d}{1,e}.Pos.correcteddata;
