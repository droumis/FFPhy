...
% % 
% cd '/data25/sjadhav/HPExpt/HPc/'
% prefix='HPc';
% dir='/data25/sjadhav/HPExpt/HPc/';
% dir2='/data25/sjadhav/HPExpt/HPc_direct/';
...
% DEC2013 - CHanging length of task and linpos to match that of pos/ rawpos
...
% THIS FUNCTION UPDATES LINPOS, BEHAVESTATE, AND TASK
% days = 1:8;
% for d = 1:length(days)
%     currday = days(d)
%     sj_matchlinposandtasklength(dir2,prefix,currday);
% end
...
cd '/mnt/data25/sjadhav/HPExpt/HPa/'
prefix='HPa';
dir='/mnt/data25/sjadhav/HPExpt/HPa/';
dir2='/mnt/data25/sjadhav/HPExpt/HPa_direct/';
...
% cd '/mnt/data25/sjadhav/HPExpt/HPb/'
% prefix='HPb';
% dir='/mnt/data25/sjadhav/HPExpt/HPb/';
% dir2='/mnt/data25/sjadhav/HPExpt/HPb_direct/';
