...
savefile = [savedir 'HP_ripunmod_corrandcoactz_PFCtest']; area = 'PFC'; clr = 'b'; % PFC
...
if runscript == 1
    ...
    % %Cell filter
    % %-----------
    %  cellpairfilter = {'strcmp($area, ''PFC'') && strcmp($ripmodtag, ''n'')'}; % Ripple unmod
    %  cellpairfilter = {'strcmp($area, ''PFC'') && strcmp($ripmodtag, ''y'')'}; % Ripple mod
...
figdir = '/mnt/data25/sjadhav/HPExpt/Figures/RippleMod/PoplnDR/';
summdir = figdir;
