function [basefr0] = sj_HPexpt_ripalign_singlecell_getrip(prefix, day, epoch, riptet, Hptets, PFCtet, PFCcell, binsize, saveg1, dospeed)
...
load(cellinfofile);
filterString = ' (   strcmp($tag, ''CA1Pyr'') || strcmp($tag, ''iCA1Pyr'')    )'
...
nstd = round(binsize*3/binsize); g1 = gaussian(nstd, 3*nstd+1);
