...
%savefile = [savedir 'HP_thetamod_CA1']; area = 'CA1';  clr = 'r';% CA1
savefig1=0;
...
if runscript == 1
    ...
    ca1reftetfilter = '(isequal($descrip, ''CA1Ref''))';
...
gatherdatafile = [savedir 'HP_thetamod_PFC_gather']; % PFC cells to Hipp theta
