function [basefr0] = sj_HPexpt_ripalign_singlecell_getrip3(prefix, day, epochs, riptets, Hptets, PFCtet, PFCcell, binsize, saveg1, dospeed)
...
cellcountthresh = 2;  % Need to reduce in Familiar Days - For hipp cells
...
for c=1:length(rip_spks_cellsort_PFC)
    ...
    plotraster_marker(tmps,(length(rip_spks_cellsort_PFC)-c+1)*ones(size(tmps)),0.8,[]);
