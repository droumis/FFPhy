function out = getpopulationevents_nolinpos(indices, excludeperiods, spikes, pos, ripples, cellinfo, cellcountthresh,varargin)
%
...
if ~isempty(riptimes)
    ...
    for cellcount = 1:size(indices,1)
        ...
        if ~isempty(spikes{index(1)}{index(2)}{index(3)}{index(4)}.data)
            ...
            if isfield(spikes{index(1)}{index(2)}{index(3)}{index(4)},'lowgammaphase')
                gam = spikes{index(1)}{index(2)}{index(3)}{index(4)}.lowgammaphase;
            else
