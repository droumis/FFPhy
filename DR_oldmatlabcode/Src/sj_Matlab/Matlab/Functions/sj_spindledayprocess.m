function sj_spindledayprocess(directoryname,fileprefix,days, varargin)
...
daytetlist = [];
f = '';
defaultfilter = (['/home/shantanu/Src/Matlab/Filters/spindlefilter.mat']);
assignphase = 0;
tetfilter = '';
dognd = 0;
...
for day = days
    ...
    for fnum = 1:length(flist)
        ...
        if mod(epoch,2)
            ...
            spindle{day}{epoch}{tet}.data(:,1) = int16(temp);
            spindle{day}{epoch}{tet}.data(:,2) = int16(phase*10000);
            spindle{day}{epoch}{tet}.data(:,3) = int16(env);
            ...
            if dognd
                spindlefile = sprintf('%sEEG/%sspindlegnd%02d-%d-%02d.mat', ...
