...
% Shantanu - Starting with code from mcarr for filter specifications

srate = 1500;
d = designeegfilt(srate,8,18);
spindlefilter = d;
filterfile = sprintf('/home/shantanu/Src/Matlab/Filters/spindlefilter.mat');
save(filterfile, 'spindlefilter');
