...
% Supratheta kk May 2013
supratheta = [12 14];
d = designeegfilt(srate,supratheta(1),supratheta(2));
suprathetafilter = d;
filterfile = sprintf('/home/kkay/Src/Matlab/Filters/suprathetafilter.mat');
save(filterfile,'suprathetafilter');



%Bashir  (kk)
%Used bonlowgammafilter for slow gamma

highgamma = [50 90];
d = designeegfilt(srate,highgamma(1),highgamma(2));
highgammafilter = d;
filterfile = sprintf('/home/kkay/matlab/Filters/bashighgammafilter.mat');
save(filterfile,'highgammafilter');

fastfastgamma = [100 140];
d = designeegfilt(srate,fastfastgamma(1),fastfastgamma(2));
fastfastgammafilter = d;
filterfile = sprintf('/home/kkay/matlab/Filters/basfastfastgammafilter.mat');
save(filterfile,'fastfastgammafilter');
