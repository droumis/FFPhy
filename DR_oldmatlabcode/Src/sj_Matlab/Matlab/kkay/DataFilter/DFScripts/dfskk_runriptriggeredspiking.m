...
timefilter = { {'kk_get2dstate', '$velocity < 4'} } ;  ...
               {'kk_getriptimes', '($nripples >= 2)', [], 'cellfilter', '(isequal($area, ''CA1''))'}};
...
ca1f = setfilterfunction(ca1f, 'dfakk_getriptriggeredspiking', {'ripple','ripples','spikes','tetinfo'},'tetfilter','(isequal($area, ''CA1''))', ...
                                                                                        'minthresh',3,'window',[0.5 0.5]);
ca2f = setfilterfunction(ca2f, 'dfakk_getriptriggeredspiking', {'ripple','ripples','spikes','tetinfo'},'tetfilter','(isequal($area, ''CA1''))', ...
                                                                                        'minthresh',3,'window',[0.5 0.5]);
ca3f = setfilterfunction(ca3f, 'dfakk_getriptriggeredspiking', {'ripple','ripples','spikes','tetinfo'},'tetfilter','(isequal($area, ''CA1''))', ... 
                                                                                        'minthresh',3,'window',[0.5 0.5]);
