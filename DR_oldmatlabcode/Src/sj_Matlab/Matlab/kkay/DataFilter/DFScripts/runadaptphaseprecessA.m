...
for i = 1:14
    epochfilter{i} = ['isequal($environment, ''TrackA'') & ($exposure == ', num2str(i), ')'];
end
...
save /data/mkarlsso/Adaptive/ca3trackA.mat  ca3f;
clear ca3f;

ca1f = runfilter(ca1f);

save /data/mkarlsso/Adaptive/ca1trackA.mat  ca1f;
clear ca1f;
