...
timestep = mean(diff(linpos{index(1)}{index(2)}.Pos.correcteddata(:,1)));
if isempty(smooth)
    linv=linpos{index(1)}{index(2)}.Pos.correcteddata(:,5);
    linv(linpos{index(1)}{index(2)}.Pos.correcteddata(:,5)==-1)=NaN;
