...
function [statematrix, segmenttable, trajwells, wellSegmentInfo, segmentInfo, ...
    trajmatrix] = linearizererouteposition(directoryname,fileprefix, index, varargin)
...
%load the data
load(strcat(directoryname,fileprefix,'_', dsz, num2str(index(1)), '.mat'));
%eval(['Data = ',lowercasethree,'pos;'])
load(strcat(directoryname,fileprefix,'_',dsz, num2str(index(1)), 'task.mat'));
...
[segmenttable, wellindex, trajwells, wellSegmentInfo, segmentInfo] = getSegmentTable(firstcoord,track);
...
trajmatrix = gettraject(pos, welllocations,trajwells, lindist, wellSegmentInfo, welldist, mindiff, welldistthresh,branchpointdist,track);
...
%---------------------------------------------------------------------
%---------------------------------------------------------------------
function [segmenttable, wellindex, trajwells, wellSegmentInfo, segmentInfo] = getSegmentTable(firstcoord,track)
...
function trajmatrix = gettraject(pos, welllocations,trajwells, lindist, wellSegmentInfo, welldist, mindiff, welldistthresh,branchpointdist,track);
