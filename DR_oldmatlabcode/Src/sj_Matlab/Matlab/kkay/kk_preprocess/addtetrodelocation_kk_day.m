function addtetrodelocation_kk_day(animdirect,fileprefix,tetrode,days,area,subarea)
...
targetcells = o.index(find(ismember(o.index(:,1),days) & ismember(o.index(:,3),tetrode)),:);
...
try
    ...
    targettets = a.index(find(ismember(a.index(:,1),days) & ismember(a.index(:,3),tetrode)),:);
