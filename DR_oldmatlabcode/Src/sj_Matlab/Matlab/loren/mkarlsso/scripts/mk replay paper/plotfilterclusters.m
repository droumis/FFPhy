function [h] = plofilterclusters(aname, basedir, f, fi, c, geom)
% [h] = plotfilterclusters(aname, basedir, trainingfilter, trainingindex, celllist, geometry)
...
for row = 1:geom(1)
	...
	if (i <= size(c,1))
	    ...
	    tme = spikes{day}{epoch}{c(i,3)}{c(i,4)}.timerange / 10000;
