...
%
% calculates the overlap between the trajectories in trajdata1 and 2,
% calculated as the 2 * the shared area / the sum of the areas
% options are
%	'normalize', 0 or 1   1 indicates that the place fields should be
%				normalized before overlap is calculated
%	'thresh', threshold   only calculate the overlap of if the peak rate is 
%				> threshold
