...
function [ep] = sj_epsp_amp_tet (animdirect,prefix,days,allepochs,tet,ref, figopt1,saveg1,figopt2,saveg2,savedata)

% From sj_stimresp2_withvel2 on 18 May 2011
% EPSPs for given tetrode across days. Plots Summary Bar Graph of EPSPAmp.
% Also saves data for sj_ltp1_summ2
...
%%%% Epochs across days
% eg
% sj_epsp_amp_tet('/data25/sjadhav/RippleInterruption/REd_direct','REd',1:9,[1 3 5],[2 3 4 5 6 8 10 11],[],1,0,0,0,0);
...
% figopt1: Make EPSP plot for individual day
% saveg1: Save individual day graphs
% figopt2: Make bar plot for individual day 
