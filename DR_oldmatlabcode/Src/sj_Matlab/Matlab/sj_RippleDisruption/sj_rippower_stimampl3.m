function [basefr0] = sj_rippower_stimampl3(prefix, day, epoch, binsize, manytet, maintet, tets, nostim, saveg1)
...
switch prefix
    ...
    case 'REh'
        if day>12 && day~=16 && day~=17
            directoryname = '/data25/sjadhav/RippleInterruption/REh_direct/StimAmpl';
        else
...
switch prefix      % BY ANIMAL
    ...
    case 'REh'        
        switch day
            ...
            case 15
                nranges=5;
                [range1] = timetrans({'00:01:37', '00:04:45'},10000,2); amp1=0; %0
                [range2] = timetrans({'00:05:25', '00:08:25'},10000,2); amp2=50; %50
                [range3] = timetrans({'00:08:35', '00:11:35'},10000,2); amp3=100; %100
                [range4] = timetrans({'00:12:15', '00:15:15'},10000,2); amp4=150; %150
                [range5] = timetrans({'00:15:35', '00:18:35'},10000,2); amp5=200; %200
                
            case 16
                nranges=1;
                [range1] = timetrans({'00:01:31', '00:11:57'},10000,2); amp1=0; % 70
                
            case 17
                nranges=1;
                [range1] = timetrans({'00:01:44', '00:12:44'},10000,2); amp1=0; % 60
            
            case 1                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:15:42', '00:31:29'},10000,2); amp1=60;
                    case 4
                        [range1] = timetrans({'00:52:32', '01:07:43'},10000,2); amp1=60;
            ...
            case 2                
                ...
                switch epoch
                    case 2
                        [range1] = timetrans({'00:29:50', '00:45:00'},10000,2); amp1=80;
                    case 4
                        [range1] = timetrans({'01:03:47', '01:18:54'},10000,2); amp1=80;
                end % end switch epoch        
            ...
            case 3                
                ...
                switch epoch
                    case 2
                        [range1] = timetrans({'00:20:16', '00:35:21'},10000,2); amp1=80;
                    case 4
                        [range1] = timetrans({'00:53:09', '01:08:19'},10000,2); amp1=80;
                end % end switch epoch       
            ...
            case 4                
                ...
                switch epoch
                    case 2
                        [range1] = timetrans({'00:30:30', '00:45:38'},10000,2); amp1=70;
                    case 4
                        [range1] = timetrans({'01:03:18', '01:17:00'},10000,2); amp1=70;
                end % end switch epoch      
            ...
            case 5                
                ...
                switch epoch
                    case 2
                        [range1] = timetrans({'00:48:28', '01:03:42'},10000,2); amp1=70;
                    case 4
                        [range1] = timetrans({'01:21:53', '01:37:00'},10000,2); amp1=70;
                end % end switch epoch      
    ...
    case 'REg'
        switch day
            ...
            case 15
                ...
                % 60uA;  Nthr=1
                nranges=1;
                [range1] = timetrans({'02:36:17', '02:47:10'},10000,2); amp1=60;       
                
            case 16
                nranges=5;
                [range1] = timetrans({'01:14:33', '01:17:38'},10000,2); amp1=0; %0
                [range2] = timetrans({'01:17:40', '01:20:45'},10000,2); amp2=20; %20
                [range3] = timetrans({'01:20:55', '01:24:00'},10000,2); amp3=30; %30
                [range4] = timetrans({'01:24:05', '01:27:10'},10000,2); amp4=40; %40
                [range5] = timetrans({'01:27:15', '01:30:35'},10000,2); amp5=50; %50
                
            case 17
                nranges=5;
                [range1] = timetrans({'00:04:11', '00:07:15'},10000,2); amp1=0; %0
                [range2] = timetrans({'00:07:20', '00:10:25'},10000,2); amp2=40; 
                [range3] = timetrans({'00:10:35', '00:13:40'},10000,2); amp3=45; 
                [range4] = timetrans({'00:14:25', '00:19:00'},10000,2); amp4=50; 
                [range5] = timetrans({'00:19:25', '00:22:25'},10000,2); amp5=55; 
                [range5] = timetrans({'00:22:35', '00:25:50'},10000,2); amp5=60; 
                
            case 19
                nranges=3;
                [range1] = timetrans({'01:19:36', '01:21:49'},10000,2); amp1=50; %0
                [range2] = timetrans({'01:21:50', '01:23:50'},10000,2); amp2=60; 
                [range3] = timetrans({'01:24:30', '01:25:39'},10000,2); amp3=20; 
                
            case 1                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:21:30', '00:36:31'},10000,2); amp1=50;
                    case 4
                        [range1] = timetrans({'00:57:16', '01:05:17'},10000,2); amp1=50;
                end % end switch epoch
            case 2
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:20:28', '00:35:33'},10000,2); amp1=50;
                    case 4
                        [range1] = timetrans({'00:56:12', '01:11:21'},10000,2); amp1=50;
                end % end switch epoch
            ...
            case 3
                ...
                switch epoch
                    case 2
                        [range1] = timetrans({'00:52:34', '01:07:50'},10000,2); amp1=50;
                    case 4
                        [range1] = timetrans({'01:26:48', '01:42:56'},10000,2); amp1=50;
                end % end switch epoch
            ...
            case 4
                ...
                switch epoch
                    case 2
                        [range1] = timetrans({'00:18:27', '00:34:12'},10000,2); amp1=50;
                    case 4
                        [range1] = timetrans({'00:52:03', '01:07:45'},10000,2); amp1=50;
                end % end switch epoch
            ...
            case 5
                ...
                switch epoch
                    case 2
                        [range1] = timetrans({'00:23:24', '00:39:05'},10000,2); amp1=50;
                    case 4
                        [range1] = timetrans({'00:58:17', '01:13:26'},10000,2); amp1=50;
                end % end switch epoch
            ...
            case 6
                ...
                switch epoch
                    case 2
                        [range1] = timetrans({'00:21:20', '00:38:46'},10000,2); amp1=50;
                    case 4
                        [range1] = timetrans({'00:56:57', '01:13:24'},10000,2); amp1=50;
                end % end switch epoch
    ...
    case 'RCd'
        ...
        switch day
            ...
            case 2
                ...
                switch epoch
                    case 2
                        [range1] = timetrans({'00:25:39', '00:40:40'},10000,2); amp1=60;
                    case 4
                        [range1] = timetrans({'00:59:18', '01:14:19'},10000,2); amp1=60;
    ...
    case 'RCc'
        ...
        switch day
            ...
            case 1
                % Day1 - Control Stim On; Rip Detectn on Tets 2,3,5,6,11,13
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:22:21', '00:37:22'},10000,2); amp1=30;
                    case 4
                        [range1] = timetrans({'00:57:40', '01:12:41'},10000,2); amp1=30;
                        
                end % end switch epoch
                
            case 2
                % Day2 - Control Stim On; Rip Detectn on Tets 2,3,5,6,11,13
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:35:50', '00:50:51'},10000,2); amp1=40;
                    case 4
                        [range1] = timetrans({'01:10:41', '01:25:42'},10000,2); amp1=40;
                        
                end % end switch epoch
                
            case 3
                % Day3 - Control Stim On; Rip Detectn on Tets 2,3,5,6,11,13
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:34:46', '00:49:47'},10000,2); amp1=60;
                    case 4
                        [range1] = timetrans({'01:07:35', '01:22:36'},10000,2); amp1=60;
                        
                end % end switch epoch
                
                
            case 4
                % Day4 - Control Stim On; Rip Detectn on Tets 2,3,5,6,11,13
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:37:37', '00:52:38'},10000,2); amp1=50;
                    case 4
                        [range1] = timetrans({'01:11:45', '01:26:46'},10000,2); amp1=50;
                        
                end % end switch epoch
                
            case 5
                % Day5 - Control Stim On; Rip Detectn on Tets 2,3,5,6,11,13
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:30:36', '00:45:37'},10000,2); amp1=40;
                    case 4
                        [range1] = timetrans({'01:03:43', '01:18:44'},10000,2); amp1=40;
                        
                end % end switch epoch
            
             case 6
                % Day6 - Control Stim On; Rip Detectn on Tets 2,3,5,6,11,13
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:29:30', '00:44:31'},10000,2); amp1=40;
                    case 4
                        [range1] = timetrans({'01:04:11', '01:19:12'},10000,2); amp1=40;
                        
                end % end switch epoch
                
             case 7
                % Day7 - Control Stim On; Rip Detectn on Tets 2,3,5,6,11,13
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:32:13', '00:48:31'},10000,2); amp1=40;
                    case 4
                        [range1] = timetrans({'01:07:19', '01:22:20'},10000,2); amp1=40;
    ...
    case 'RCb'
        ...
        switch day
            ...
            case 2
                % Day2 - Control Stim On; Rip Detectn on Tets 3,4,9,10,11,12
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:21:09', '00:36:43'},10000,2); amp1=100;
                    case 4
                        [range1] = timetrans({'00:55:10', '01:10:11'},10000,2); amp1=100;
                        
                end % end switch epoch
                
            case 3
                % Day3 - Control Stim On; Rip Detectn on Tets 3,4,9,10,11,12
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:34:10', '00:49:15'},10000,2); amp1=100;
                    case 4
                        [range1] = timetrans({'01:07:00', '01:22:01'},10000,2); amp1=100;
                        
                end % end switch epoch
                
            case 4
                % Day4 - Control Stim On; Rip Detectn on Tets 3,4,9,10,11,12
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:33:08', '00:48:09'},10000,2); amp1=100;
                    case 4
                        [range1] = timetrans({'01:05:54', '01:20:55'},10000,2); amp1=100;
                        
                end % end switch epoch
             
            case 5
                % Day5 - Control Stim On; Rip Detectn on Tets 3,4,9,10,11,12
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:43:57', '00:58:58'},10000,2); amp1=100;
                    case 4
                        [range1] = timetrans({'01:18:10', '01:33:11'},10000,2); amp1=100;
                        
                end % end switch epoch
                
            case 8
                % Day8 - Control Stim On; Rip Detectn on Tets 3,4,9,10,11,12
                % 150ms delay
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:43:42', '00:58:43'},10000,2); amp1=100;
                    case 4
                        [range1] = timetrans({'01:18:05', '01:33:06'},10000,2); amp1=100;
                        
                end % end switch epoch
                
                
            case 9
                % Day9 - Control Stim On; Rip Detectn on Tets 3,4,9,10,11,12
                % 0ms delay - Doing Disruption
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:27:44', '00:42:45'},10000,2); amp1=150;
                    case 4
                        [range1] = timetrans({'01:01:11', '01:16:12'},10000,2); amp1=150;
                        
                end % end switch epoch
                
                
            case 10
                % Day10 - Control Stim On; Rip Detectn on Tets 3,4,9,10,11,12
                % 0ms delay - Doing Disruption
                
                nranges=1;
                switch epoch
                    case 2
                        [range1] = timetrans({'00:25:24', '00:40:25'},10000,2); amp1=120;
                    case 4
                        [range1] = timetrans({'00:59:22', '01:14:23'},10000,2); amp1=120;
...
%     end
    ...
    % For COtrol Stimuln - Get rid os stim artifact power at 0
...
for n=1:nranges
    ...
    % If you want to plot baseline firing rate for 0uA on all plot, use
    % this
    %     plot(taxis, basefr0*ones(size(taxis)),'k--','Linewidth',2 );
