...
%   $Revision: 2.30.4.8 $  $Date: 2006/10/02 16:34:55 $
...
set(nlin_fig,'UserData',ud,'HandleVisibility','callback', ...
             'BusyAction','queue','WindowButtonMotionFcn','nlintool(''motion'',0)', ...
...
function k = findaxes(fig, allaxes)
