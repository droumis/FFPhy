...
%   'proppdf' can be replaced with 'logpdf' and 'proppdf'. The density
%   functions used in Metropolis-Hasting algorithm are not necessarily 
%   normalized. If the proppdf or logpdf q(x,y) satisfies q(x,y) = q(y,x),
%   i.e. the proposal distribution is symmetric, MHSAMPLE implements the
%   Random Walk Metropolis-Hasting sampling.  If the proppdf or logpdf
