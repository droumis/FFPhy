...
typedef struct PairedData {
  int n, nc, nf;
  Bars_X_Grid *xg, *cg, *fg;
  double *x_raw, x_rawmax, x_rawmin;
  double *y;
  int *ccount,use_collapsed;
} Bars_PairedData;
...
Bars_PairedData *New_PairedData(int, int);
void Free_PairedData(Bars_PairedData *);
...
void Bars_MCMC(Bars_Model *, Bars_Model *, Bars_PairedData *, 
