function[fillhandle,msg]=sjfill1(xpoints1, xpoints2,upper,lower,color,edge,add,transparency)

%%% Shantanu, November 2007: Fill rectangular area in Psth plots

%USAGE: [fillhandle,msg]=jbfill(xpoints1, xpoints2, upper,lower,color,edge,add,transparency)
...
if length(upper)==length(lower) && length(lower)==length(xpoints1) && length(xpoints2)==length(xpoints1)
    msg='';
