...
function [outbound_curve, all_outbound_logic, all_outbound_wellstend, ntrajs_perday] = sj_findoutbound_alldays (dir, days,epochs,prefix, doprobfit, days_ex, savedata, savefig)
...
% sj_findoutbound_alldays ('/data25/sjadhav/HPExpt/HPa_direct',[1:8],[],'HPa', 1);
...
if savefig == 1    
    ...
    figfile = [figdir,prefix,'_Wtr1_Outbound']
    print('-djpeg', figfile);
