function out = DFAsj_calcproprewarded(index, excludetimes, linpos, task, varargin)
...
% assume W-track
correctorder = [2 1 3];
[trajbound, rewarded, time] = sj_trackperformance(index, excludetimes, linpos, correctorder);
