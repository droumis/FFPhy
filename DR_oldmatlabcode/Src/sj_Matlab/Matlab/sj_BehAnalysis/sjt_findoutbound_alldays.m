...
function [outbound_curve, all_outbound_logic, all_outbound_wellstend, ntrajs_perday] = sjt_findoutbound_alldays (dir, days,epochs,prefix, doprobfit, days_ex, savedata, savefig)
