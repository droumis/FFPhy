...
function [inbound_curve, all_inbound_logic, all_inbound_wellstend, ntrajs_perday] = sj_findinbound_alldays_Ada (dir, days,epochs,prefix, doprobfit,days_ex,savedata, savefig)

% 12/27/12
% sj_findinbound_alldays_Ada ('/data25/sjadhav/HPExpt/Ada_direct',[1],[1:8],'Ada',1);
