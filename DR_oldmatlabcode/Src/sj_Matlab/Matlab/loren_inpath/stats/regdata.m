...
% yfit	-Response fit using param to get yfit from curvefit use yfit=F+ydata 
%                                  where F is the error matrix from curvefit
% ydata	-Response data
...
e=yfit(:)-ydata(:); %error vectorize the Y matrix for muliple ouputs
