function hout=supertitle(str, colr)
% supertitle - put a title above all subplots.
%	SUPERTITLE('text') adds text to the top of the figure
%	above all subplots (a "super title"). Use this function
%	after all subplot commands.
%   Demetris added color variable as second input 1/9/15
...
ht=text(.5,titleypos-1,str);set(ht,'horizontalalignment','center','fontsize',fs, 'Color', colr);
set(gcf,'nextplot',np);
axes(haold);
if nargout,
	hout=ht;
