...
%        for condno = 7:7
            ...
            [thetainit thetahat dataset{i}.cell{cellnum}.KSStat] = adaptivesuzuki(stmp, cobj.spike_start(:,cellnum), cobj.spike_end(:,cellnum), timestep, ntimesteps, fixationtimes, testID, Epsx, Epst, CP.x, CP.t);
