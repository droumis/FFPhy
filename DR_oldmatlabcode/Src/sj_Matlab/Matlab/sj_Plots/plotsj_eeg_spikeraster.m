...
% STILL TO IMPLEMENT - 09Jun12
% Using align to tripple to just get a long plot with eeg and raster for now

% Similar to rip_spikeraster. Want eeg and spikes.
% Do this one like sj_plottrajdatafind. Trajectory detrmines what you are plotting.
...
cellsp(5,:) = [day epoch 18 1];
cellsp(6,:) = [day epoch 18 2]; 
cellsp(7,:) = [day epoch 18 3]; 
cellsp(8,:) = [day epoch 18 4];
...
figdir = '/data25/sjadhav/HPExpt/HPa_direct/Figures/RipEgs/';
summdir = figdir;
...
clr = {'b','m','g','y','c','k','r','b','g','y'};
 
figdir = '/data25/sjadhav/HPExpt/HPa_direct/ProcessedData/';
% ---------------------------------------
