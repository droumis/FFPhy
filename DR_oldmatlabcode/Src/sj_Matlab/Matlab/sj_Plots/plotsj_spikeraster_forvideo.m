...
switch prefix
    case 'HPa'
        directoryname = '/media/shantanu/Data/data25/sjadhav/HPExpt/HPa_direct';
        dire = '/media/shantanu/Data/data25/sjadhav/HPExpt/HPa';
        riptetlist=[1,4,5,6];
end
...
% % % Ordered - For 7760-7722  - This for Video
% winst = 7660; winend = 7690;
% %%%cellsi(1,:) = [day epoch 1 3]; % Too many
% cellsi(1,:) = [day epoch 12 2]; % iHp
% %%% cellsi(2,:) = [day epoch 8 1]; % iHp
% %cellsi(2,:) = [day epoch 1 1];
% cellsi(2,:) = [day epoch 1 5];
% cellsi(3,:) = [day epoch 4 5];
% cellsi(4,:) = [day epoch 4 6];
% cellsi(5,:) = [day epoch 4 4];
% cellsi(6,:) = [day epoch 4 3];
% %%% cellsi(8,:) = [day epoch 14 1]; %iHp % Silent
% cellsi(7,:) = [day epoch 1 6];
% %cellsi(9,:) = [day epoch 1 4]; % Can be in or out
% cellsi(9,:) = [day epoch 4 1]; 
% cellsi(8,:) = [day epoch 7 1];
% cellsi(10,:) = [day epoch 1 2];
% usecellsi=1:10;

% Video 6. First replay, then run
% winst = 7350; winend = 7411;
% cellsi(1,:) = [day epoch 1 3]; % Too many
...
% cellsi(10,:) = [day epoch 14 1]; %iHp % Silent
% cellsi(11,:) = [day epoch 1 6];
% cellsi(12,:) = [day epoch 1 4]; % Can be in or out
...
% GOOD - Video 5 - Ordered - For 7635-7653 
% winst = 7635; winend = 7652;
% cellsi(1,:) = [day epoch 1 3]; %
% cellsi(2,:) = [day epoch 12 2]; % iHp
% cellsi(3,:) = [day epoch 1 1];
% cellsi(4,:) = [day epoch 4 4];
% cellsi(5,:) = [day epoch 4 3];
% cellsi(6,:) = [day epoch 1 6];
% cellsi(7,:) = [day epoch 4 1]; 
% cellsi(8,:) = [day epoch 1 2];
% usecellsi=1:8;

% GOOD - Video 4 - Ordered For 7700-7720
% winst = 7701; winend = 7720;
% cellsi(1,:) = [day epoch 1 3]; % 
% cellsi(2,:) = [day epoch 1 1];
% cellsi(3,:) = [day epoch 4 5];
% cellsi(4,:) = [day epoch 4 4];
% cellsi(5,:) = [day epoch 4 3];
% cellsi(6,:) = [day epoch 4 1]; 
% cellsi(7,:) = [day epoch 1 2];
% usecellsi=1:7;

% GOOD - Video 3
% winst = 7314; winend = 7333;
% cellsi(1,:) = [day epoch 1 3]; % 
% cellsi(2,:) = [day epoch 8 1]; % iHp
% cellsi(3,:) = [day epoch 1 1];
...
% cellsi(6,:) = [day epoch 4 3];
% cellsi(7,:) = [day epoch 1 6];
% cellsi(8,:) = [day epoch 4 1]; 
% cellsi(9,:) = [day epoch 1 2];
% usecellsi=1:9;
