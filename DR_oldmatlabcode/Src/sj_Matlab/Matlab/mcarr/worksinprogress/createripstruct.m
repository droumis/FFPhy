                ...
                for i = ca1tetrodes'
                    ...
                    for j = ca1tetrodes'
                        if j > i
                            ...
                            count1 = count1+1;
                            if isempty(p1)
                                p1 = squeeze(mean(coherence{day}{epoch}{i}{j}.phase(:,gamma_index(1):gamma_index(2),ripind),2));
                            else
                                p1 = cat(3,p1,squeeze(mean(coherence{day}{epoch}{i}{j}.phase(:,gamma_index(1):gamma_index(2),ripind),2)));
                            end
                        end
                    end
                    for j = ca3tetrodes'
                        ...
                        count13 = count13+1;
                        if isempty(p13)
                            p13 = squeeze(mean(coherence{day}{epoch}{i}{j}.phase(:,gamma_index(1):gamma_index(2),ripind),2));
                        else
                            p13 = cat(3,p13,squeeze(mean(coherence{day}{epoch}{i}{j}.phase(:,gamma_index(1):gamma_index(2),ripind),2)));
                        end
                    end
                end
