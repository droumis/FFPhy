function lowgammadayprocess(directoryname,fileprefix,days, varargin)
...
daytetlist = [];
f = '';
defaultfilter = (['/home/mcarr/Src/Matlab/Filters/',fileprefix,'lowgammafilter.mat']);
assignphase = 0;
tetfilter = '';
subtractreference = 1;
...
for day = days
    ...
    for fnum = 1:length(flist)
        ...
        temp = filtfilt(lowgammafilter,1,eeg{day}{epoch}{tet}.data');
        hdata = hilbert(temp);
        env = abs(hdata);
        phase = angle(hdata);
        ...
        lowgamma{day}{epoch}{tet}.data(:,1) = temp;
        lowgamma{day}{epoch}{tet}.data(:,2) = phase*10000;
        lowgamma{day}{epoch}{tet}.data(:,3) = env;
        ...
        if subtractreference
            lowgammafile = sprintf('%sEEGnonreference/%slowgamma%02d-%d-%02d.mat', ...
            ...
            if ~isempty(s)
                ...
                for c = 1:length(s)
                    ...
                    if ~isempty(data)
                        ...
                        spikes{day}{epoch}{tet}{c}.lowgammaphase = ...
