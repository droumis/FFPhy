...
% Last Modified by GUIDE v2.5 26-Jun-2006 14:38:02
...
if channels > 1 % code could be added here to put the channels together
    msgbox('Only one audio channel is supported.');
    return;
end
