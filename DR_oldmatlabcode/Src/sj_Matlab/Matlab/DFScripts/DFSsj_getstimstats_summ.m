...
if figopt1 == 1
    ...
    [p_expcon_animstimrate,h_expcon_animstimrate] = ranksum(Con_animstimrate,Exp_animstimrate); %p=0.76
    ...
    set(gca,'YLim',[0 2.2]);
    if savefig1==1,
        figfile = [figdir,'0ConvsExp_AnimStimRate'];
        print('-dpdf', figfile);
        print('-djpeg', figfile);
    ...
    [h_expcon_meanstimrate,p_expcon_meanstimrate] = ttest2(Expstimrate_day(:),Constimrate_day(:)); %p=0.8365
    ...
    Con_daystimrate(1)=Con_daystimrate(1);
    Con_daystimrate(5)=Con_daystimrate(5);
    ...
    %pgrp=0.8495, ptime=0.0003, pint=0.1269
    ...
    if savefig1==1,
        figfile = [figdir,'0ConvsExp_MeanstimrateVsDays'];
        print('-dpdf', figfile);
        print('-djpeg', figfile);
        saveas(gcf,figfile,'fig');
    end
    ...
    [p_expcon_animmeanvel,h_expcon_animmeanvel] = ranksum(Con_animmeanvel,Exp_animmeanvel); %p=0.2857
    ...
    %pgrp=0.1792, ptime=0, pint=0.307
    ...
    figure; hold on;
    redimscreen_2horsubplots; jit=[0,0.05,0.1,0.15];jite=[jit,0.2,0.2];
    subplot(1,2,1); hold on;
    Exp_animfracbelow5 = mean(Expfrac_below5,2);
    Con_animfracbelow5 = mean(Confrac_below5,2);
    plot(1+jite, Exp_animfracbelow5,'ro','MarkerSize',12,'Linewidth',3);
    plot(2+jit, Con_animfracbelow5,'bd','MarkerSize',12,'Linewidth',3);
    [p_expcon_animfracbelow5,h_expcon_animfracbelow5] = ranksum(Con_animfracbelow5,Exp_animfracbelow5); %p=0.48
    axis([0.5 2.5 0 1]);
    set(gca,'XTick',[1 2],'XTickLabel',{'Exp';'Con'}','FontSize',xfont,'Fontweight','normal');
    ...
    plot(1+jite, Exp_animfracbelow10,'ro','MarkerSize',12,'Linewidth',3);
    plot(2+jit, Con_animfracbelow10,'bd','MarkerSize',12,'Linewidth',3);
    [p_expcon_animfracbelow10,h_expcon_animfracbelow10] = ranksum(Con_animfracbelow10,Exp_animfracbelow10); %p=0.1143
    axis([0.5 2.5 0 1]);
    set(gca,'XTick',[1 2],'XTickLabel',{'Exp';'Con'}','FontSize',xfont,'Fontweight','normal');
    ...
    if savefig1==1,
        figfile = [figdir,'0ConvsExp_Fracbelowthrs'];
        print('-dpdf', figfile);
        print('-djpeg', figfile);
        saveas(gcf,figfile,'fig');
    end
...
if dostimlearncorr==1
    ...
    % learning trial
    Exp_lt = [55;197;92;46;56;47];
    Con_lt = [18;11;18;15];
    % learning day
    Exp_ld = [3;8;4;3;4;3];
    Con_ld = [1;1;2;1];
    
    [rt, pt] = corrcoef(Exp_animstimrate, Exp_lt); % r=0.008, p=.99
    [rd, pd] = corrcoef(Exp_animstimrate, Exp_ld); % r=-0.09, p=.86
    [rtc, ptc] = corrcoef(Con_animstimrate, Con_lt); % r=0.47, p=0.53
    [rdc, pdc] = corrcoef(Con_animstimrate, Con_ld); % r=-0.51, p=0.48
    
    figure; hold on;
    redimscreen_2horsubplots;
    subplot(1,2,1); hold on;
    plot(Exp_animstimrate,Exp_lt,'ro','Markersize',12,'LineWidth',3); % 
    plot(Con_animstimrate,Con_lt,'bd','Markersize',12,'LineWidth',3); % 
    set(gca,'YLim',[0 201]);
    set(gca,'XLim',[0 2.1]);
    ...
    subplot(1,2,2); hold on;
    plot(Exp_animstimrate,Exp_ld,'ro','Markersize',12,'LineWidth',3); %
    plot(Con_animstimrate,Con_ld,'bd','Markersize',12,'LineWidth',3); % 
    set(gca,'YLim',[0 8.1]);
    set(gca,'XLim',[0 2.1]);
    ...
    if savefig1==1,
        figfile = [figdir,'0LearningRatevsStimRate'];
        print('-dpdf', figfile); print('-djpeg', figfile); saveas(gcf,figfile,'fig');
    end
...
if doposquant==1,
    ...
    jit=[0,0.05,0.1,0.15];jite=[jit,0.2,0.2];
    plot(1+jite, Expavgnstimwell_alldays_allwells,'ro','MarkerSize',12,'Linewidth',3);
    plot(2+jit, Conavgnstimwell_alldays_allwells,'bd','MarkerSize',12,'Linewidth',3);
    [p_expcon_allwells,h_expcon_allwells] = ranksum(Conavgnstimwell_alldays_allwells,Expavgnstimwell_alldays_allwells); 
    % p=0.76
    axis([0.5 2.5 0 1]);
    set(gca,'XTick',[1 2],'XTickLabel',{'Exp';'Con'}','FontSize',xfont,'Fontweight','normal');
    ...
    jit=[0,0.05,0.1,0.15];
    plot(1+jite, Expavgnstimint_alldays_ctr,'ro','MarkerSize',12,'Linewidth',3);
    plot(2+jit, Conavgnstimint_alldays_ctr,'bd','MarkerSize',12,'Linewidth',3);
    [p_expcon_ctrint,h_expcon_ctrint] = ranksum(Conavgnstimint_alldays_ctr,Expavgnstimint_alldays_ctr); 
    % p=1
    axis([0.5 2.5 0 1]);
    set(gca,'XTick',[1 2],'XTickLabel',{'Exp';'Con'}','FontSize',xfont,'Fontweight','normal');
    ...
    %pgrp=0.6872, ptime=0.00, pint=0.3021
    ...
    %pgrp=0.7349, ptime=0.03, pint=0.8225
...
if dovelstim_befaft==1,
    ...
    Conmean_befaft = mean(Convelstim_befaft_alldays);
    Conerr_befaft = sem(Convelstim_befaft_alldays);
    Expmean_befaft = mean(Expvelstim_befaft_alldays);
    ...
    plot(xhist,Expmean_befaftnorm,'r-','Linewidth',3,'MarkerSize',2);
    jbfill(xhist, [Conmean_befaftnorm+Conerr_befaft],[Conmean_befaftnorm-Conerr_befaft],'b','b',1,1);
    jbfill(xhist, [Expmean_befaftnorm+Experr_befaft],[Expmean_befaftnorm-Experr_befaft],'r','r',1,1);
    ...
    if savefig1==1,
        figfile = [figdir,'0velstim_befaft_axis'];
        print('-dpdf', figfile);
        print('-djpeg', figfile);
        saveas(gcf,figfile,'fig');
    end
    ...
    Conmean_velstim_diff_byanim(2)=Conmean_velstim_diff_byanim(2);
    jit=[0,0.05,0.1,0.15];jite=[jit,0.2,0.2];
    plot(1+jite, Expmean_velstim_diff_byanim,'ro','MarkerSize',12,'Linewidth',3);
    plot(2+jit, Conmean_velstim_diff_byanim,'bd','MarkerSize',12,'Linewidth',3);
    [p_velstim_diff,h_velstim_diff] = ranksum(Expmean_velstim_diff_byanim,Conmean_velstim_diff_byanim); %p=0.1714
    axis([0.5 2.5 -2 0.5]);
    set(gca,'XTick',[1 2],'XTickLabel',{'Exp';'Con'}','FontSize',xfont,'Fontweight','normal');
    ...
    if savefig1==1,
       figfile = [figdir,'0velstim_diff_byanim_1swin'];
       print('-dpdf', figfile);
       print('-djpeg', figfile);
       saveas(gcf,figfile,'fig');
    end
