function nmakeparamsNoPos_pc(datafile,tetnum, waves, timestamps, THRESH, MAXALLOWEDAMP, dopc)
%
% Usually called from makedayparams_pc
% Get PCs in addition to other spike parameters. 
% Shantanu - May 2012
%
%
...
[addn_params] = addpc(waves,triggers,dopc);
