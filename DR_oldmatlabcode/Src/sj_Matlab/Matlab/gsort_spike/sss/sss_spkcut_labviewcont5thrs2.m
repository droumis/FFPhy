function [spikes,aspkfile]=sss_spkcut_labviewcont5thrs2(files, ch, Fs, sdcuts, threshold, stimcode, params, consweep, sweepall, sweepstim)
...
% sss_spkcut_labviewcont5thrs2('spike.dat',[1:4],32000,4,1);
