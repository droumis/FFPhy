function [spikes,aspkfile]=sss_spkcut_labviewcont4(files, ch, Fs, sdcuts, threshold, stimcode, params, consweep, sweepall, sweepstim)
...
% sss_spkcut_labviewcont4({'spike.dat';'spike.dat';'spike.dat';'spike.dat';'spike.dat';'spike.dat';'spike.dat';'spike.dat';'spike.dat';'spike.dat'},[1:4],32000,4,1);
