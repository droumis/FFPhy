function [spikes,aspkfile]=sss_autospikecut_1ms_basic(files,sdcuts, stimcode, consweep, sweepall, sweepstim)
% sss_autospikecut_1ms_basic({'CR03p3r2DeL4';'CR03p3r3DeL4';'CR03p3r4DeL4';'CR03p3r5
% DeL4';'CR03p3r1DeL4'}, [0 1 0 1 100], 1, [1:1090], {[1:200 601:800]; [201:600 801:1000]; [1001:1090]});
