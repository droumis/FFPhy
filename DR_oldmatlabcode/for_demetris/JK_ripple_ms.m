...
% load data... right not i just need the eeg and ripples
...
%% generate variable to hold EEG for entire tetrode across epochs
...
% % plot(eegepoch, 'Color', 'b')
% for i = 1:length(lines)
% line([lines(i) lines(i)],[-450 450], 'Color', 'g')
% end
% % end
% 
% 
