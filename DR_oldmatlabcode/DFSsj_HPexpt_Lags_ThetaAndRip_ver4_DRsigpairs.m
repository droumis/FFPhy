...
% PUT MANUAL DATA
val=1;savefile = [savedir 'HPall_CA1PFC_Lags_ThetaAndRip_std3_speed4_ntet2_alldata_2-21-2014']; area = 'CA1thetamodPFCripmod'; clr = 'r';
...
mkdir('/mnt/data25/sjadhav/HPExpt/Figures_DR/XCorrgrams_SigPairs_AllHP');
figdir = '/mnt/data25/sjadhav/HPExpt/Figures_DR/XCorrgrams_SigPairs_AllHP/';
