...
if runscript==1
    val=6;savefile = [savedir,'HP_ripplemod_PFC_alldata_std3_speed4_ntet2_',num2str(m),'-',num2str(d),'-',num2str(y)]; area = 'PFC'; clr = 'b'; % PFC - low speed criterion
    %val=7;savefile = [savedir,'HP_ripplemod_CA1_alldata_std3_speed4_ntet2_',num2str(m),'-',num2str(d),'-',num2str(y)]; area = 'CA1'; clr = 'r'; % CA1
else
    val=6;savefile = [savedir,'HP_ripplemod_PFC_alldata_std3_speed4_ntet2_2-19-2014']; area = 'PFC'; clr = 'b'; % PFC. 74 Mod, 137 UnMod, 211 total
...
switch val
    case 6
        if gatherdata
            gatherdatafile = [savedir 'HP_ripplemod_PFC_alldata_std3_speed4_ntet2_Nspk50_gather_',num2str(m),'-',num2str(d),'-',num2str(y)]; % PFC cells to Hipp ripples - low speed criterion
        else
