...
function [task] = sj_addripmodtag4(animno,animdirect,fileprefix)

% sj_addripmodtag4(1,'/data25/sjadhav/HPExpt/HPa_direct/','HPa');
% sj_addripmodtag4(2,'/data25/sjadhav/HPExpt/HPb_direct/','HPb');
% sj_addripmodtag4(3,'/data25/sjadhav/HPExpt/HPc_direct/','HPc');
% sj_addripmodtag4(4,'/data25/sjadhav/HPExpt/Ndl_direct/','Ndl');
...
for i = 1:size(targetcells,1)
    ...
    cellinfo{targetcells(i,1)}{targetcells(i,2)}{targetcells(i,3)}{targetcells(i,4)}.ripmodtype = 'u'; % exc or inh
    ...
    % Exc or inh
    cellinfo{targetcells(i,1)}{targetcells(i,2)}{targetcells(i,3)}{targetcells(i,4)}.runripmodtype = 'u';
    cellinfo{targetcells(i,1)}{targetcells(i,2)}{targetcells(i,3)}{targetcells(i,4)}.postsleepripmodtype = 'u';
    cellinfo{targetcells(i,1)}{targetcells(i,2)}{targetcells(i,3)}{targetcells(i,4)}.presleepripmodtype = 'u';
end
            ...
            if ~isempty(cellinfo{d}{ep}{tet}) % if cells for the tet
                for c=1:length(cellinfo{d}{ep}{tet})
                    ...
                    if match~=0
                        ...
                        % Put the type - regardless of significant or not
                        cellinfo{d}{ep}{tet}{c}.ripmodtype = allripplemod(getdataidx).type;
                        cellinfo{d}{ep}{tet}{c}.runripmodtype = allripplemod(getdataidx).type;
...
%                             % Put the type - regardless of significant or not
%                             cellinfo{d}{ep}{tet}{c}.ripmodtype = allripplemod(getdataidx).type;
%                             cellinfo{d}{ep}{tet}{c}.postsleepripmodtype = allripplemod(getdataidx).type;
%                             
%                             if allripplemod(getdataidx).sig_shuf==1
%                                 cellinfo{d}{ep}{tet}{c}.ripmodtag='y';
%                                 for tmpe=allepochs
...
%                             % Put the type - regardless of significant or not
%                             cellinfo{d}{ep}{tet}{c}.ripmodtype = allripplemod(getdataidx).type;
%                             cellinfo{d}{ep}{tet}{c}.presleepripmodtype = allripplemod(getdataidx).type;
%                             
%                             
