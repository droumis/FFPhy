...
%6/8/14 DR This is the same thing as getestprobcorrect except that it returns all the variables needed to plot instead of plotting itself.. also there's plotfigs =0 to prevent this from plotting
...
function [t, p, bmode, b05, b95, bp, background_prob, sige, pmatrix, pc, lt] = DR_getestprobcorrect(bp, background_prob, startflag)
