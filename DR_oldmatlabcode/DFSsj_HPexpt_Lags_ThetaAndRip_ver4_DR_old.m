...
% PUT MANUAL DATA
%val=1;savefile = [savedir 'HP_CA1PFC_Lags_ThetaAndRip_std3_speed4_ntet2_alldata_2-18-2014']; area = 'CA1thetamodPFCripmod'; clr = 'r';
...
val=1;savefile = [savedir 'HPa_PFCall_Lags_std3_speed4_ntet2_alldata_DRTEST']; area = 'CA1PFCripmod'; clr = 'c';
...
%     switch val
%         case 1  
            cellpairfilter = {'allcomb','(strcmp($area, ''CA1'') || strcmp($area, ''iCA1'')) && ($numspikes > 100)','strcmp($area, ''PFC'') && ($numspikes > 100) && strcmp($ripmodtag2, ''y'')'};
%     % %IMP! CA1theta
%     % %------------------------
%         case 2
...
%     timefilter_place_new = { {'DFTFsj_getvelpos', '($absvel >= 5)'}, {'DFTFsj_getriptimes','($nripples == 0)','tetfilter',riptetfilter,'minthresh',3} };
...
%     
    ...
    % Ripple Correlation
    % -
    modf = createfilter('animal',animals, 'days',dayfilter, 'epochs',runepochfilter, 'cellpairs', cellpairfilter, 'excludetime', timefilter_rip, 'iterator', iterator);
