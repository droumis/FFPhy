...
saverippos = '_vel4tet2filt';

savedir = '/mnt/data25/sjadhav/HPExpt/ProcessedDataDR/';
savefile = [savedir 'AllAn_PFCCA1_ripplepos_DR']; area = 'PFC'; clr = 'b'; % PFC
...
runepochfilter = 'isequal($type, ''run'') && ~isequal($environment, ''lin'')';
    ...
    % Should be similar to getripples/ getripplees_direct
       ...
       timefilterrun_rip = {{'DFTFsj_getvelpos', '(($absvel <= 4))'}, {'DFTFsj_getriptimes','($nripples > 6)','tetfilter',riptetfilter,'minthresh',3}};
