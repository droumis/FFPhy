...
%eegstruct=loadeegstruct('/mnt/data12/mari/Egy/','egy','eeg', 8, [], []);
day = day;
epoch = epoch;
tetrodes = 4;
t = tetrodes;
Fs=eegstruct{day}{epoch}{t}.samprate;
...
pulsetimes=eventstruct{day}{epoch}{refbit}.pulsetimes(12,1);
...
for k=1:length(events)
        figure
    epoch_starttime=eegstruct{day}{epoch}{4}.starttime;
    epoch_times=epoch_starttime:1/Fs:(epoch_starttime+(1/Fs)*length(eegstruct{day}{epoch}{4}.data));
