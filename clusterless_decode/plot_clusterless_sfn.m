...
place_map_only = 0;
    ...
    if plotter || analyze
        ...
        if ~exist('P','var') || isempty(P) || ~strcmp(P.animalname,animal_toplot) || ...
               ~all(P.dayep == dayep)
           % Decode file %%%%%%%%%%%%%%
            load(sprintf('%s_%d_%d_fullepoch_1_outpos.mat',animpref,d,ep),'P');
            tvec = (1:size(P.posteriors{1},2))/1000;   % 1 ms timevec   
           % Positional %%%%%%%%%%%%%%%%%%%
        ...
        if 0
            ...
            post = P.posteriors{1}(:,a:b);
        
        elseif 1
            
            validxbins = P.validxbins{1};
            post        = P.posteriors{1}(validxbins,a:b);
