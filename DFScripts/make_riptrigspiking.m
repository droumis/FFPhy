...
% also looking at dfs_riptrigspiking_20180423 and notebook_template
...
Fp.animals = {'D10'}; % don't use D!2 day 7 until the sorting is done
% Fp.days = [1:6]; %  i need a better way of filtering out non-pure w days.. 
