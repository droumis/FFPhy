...
% DR exporting ec.maxthresh; % # stdevs of peak from baseline
...
%         evalid = (ec.maxthresh > minstdthresh & ec.maxthresh < maxstdthresh );
        evalid = (ec.maxthresh > minstdthresh);
...
%         out{epochs(i,1)}{epochs(i,2)}.tets = ec.tetlist;
%         out{epochs(i,1)}{epochs(i,2)}.starttime = ec.starttime;
%         out{epochs(i,1)}{epochs(i,2)}.endtime = ec.endtime;
%         out{epochs(i,1)}{epochs(i,2)}.maxthresh = ec.maxthresh; % # stdevs of peak from baseline
        clear times
        clear cons
        clear ectimes
        clear ec
