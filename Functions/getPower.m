...
%     ntrodes = lfpstack(ian).ntrodes;
    ...
    pwrout(ian).meandbpower = meanpwr;
    pwrout(ian).mediandbpower = medianpwr;
    pwrout(ian).meanZpower = meanZpwr;
    ...
    if savepower
        ...
        savestr = sprintf('%s/power_%s_%s_waveSet-%s.mat', savedir, animal, 'wtrack', ...
            Fp.waveSet);
