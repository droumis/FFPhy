function [out, ripplestdout] = JY_getripples(index, ripples, varargin)
%Modified from getripples, don't need cells to pick tetlist, tetlist is
%specified in varargin 'tetrodreference'
